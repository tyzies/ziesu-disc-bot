...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if(!args.length || args.join(" ") === "all"){
            ...
            .addField("<a:important:536987777372258339> **Help Stop COVID-19!**", `[Preventing COVID-19](https://who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public)`, true)
